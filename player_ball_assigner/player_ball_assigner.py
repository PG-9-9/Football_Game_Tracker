...
class PlayerBallAssigner():
    ...
    def assign_ball_to_player(self,players,ball_bbox):
        ...
        for player_id, player in players.items():
            ...
            distance_left=measure_distance((player_bbox[0],player_bbox[-1]),# Bottom left corner
                                           (ball_position))
            distance_right=measure_distance((player_bbox[2],player_bbox[-1]),# Bottom right corner
                                             (ball_position))
